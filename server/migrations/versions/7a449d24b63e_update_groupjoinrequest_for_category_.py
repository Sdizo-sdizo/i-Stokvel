...
def upgrade():
    ...
    # op.drop_table('beneficiary')   # <--- Commented out to avoid error
    ...
    with op.batch_alter_table('group_join_request', schema=None) as batch_op:
        ...
        pass  # Add this if all lines are commented out

    # Backfill with a default value (adjust as needed)
    # You can leave these lines if you want to update existing rows, or comment them out if you get errors:
